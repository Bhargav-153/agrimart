...
const Nursery = () => {
  ...
  useEffect(() => {
    const fetchNurseries = async () => {
      try {
        const res = await fetch(`${getEnv("VITE_API_BASE_URL")}/nursery/all-nursery`);
  ...
  return (
    <div className={styles.nurseryContainer}>
      <div className="text-center mb-6">
        ...
        <h3 className="text-lg text-muted-foreground">Flowering & Fruit Plants</h3>
        <div className="mt-4">
          <Button asChild>
            ...
            <Card key={i} className="pt-5">
              <CardContent>
                ...
                <div className={styles.farmerInfo}>
                  <p><strong>Nursery:</strong> {n.nurseryName}</p>
                  <p><strong>Address:</strong> {n.address}</p>
